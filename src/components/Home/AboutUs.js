        ...
        <div className="flex flex-col items-center md:flex-row ">
          ...
          <div className="w-full md:w-1/2 text-justify">
            ...
            <p className="mb-4">
              ...
              selama hampir 23 tahun. Para pendiri, yang telah berpengalaman
              dalam berbagai proyek konstruksi di seluruh Indonesia, menyadari
              kompleksitas rantai pasok dan manajemen konstruksi yang memerlukan
              presisi tinggi.
            </p>

            <p className=" mb-4">
              Leora lahir dari tekad memberikan solusi komprehensif,
              menghadirkan inovasi, keberlanjutan, dan kerjasama luar biasa
              dalam industri konstruksi. Kami berbagi perjalanan ini dengan
              Anda, semoga menjadi mitra tepercaya dalam membangun masa depan
              yang lebih baik untuk ekosistem konstruksi.
            </p>
            ...
            <p className="mb-4">
              ...
              infrastruktur yang tangguh untuk mendukung pertumbuhan ekonomi
              yang resilien.
            </p>
          </div>
        </div>
